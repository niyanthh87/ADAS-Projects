...
def general_search(binary_warped, left_fit, right_fit):
    ...
    print(len(window_img),left_line_pts)
    left_line_pts=left_line_pts.astype(int)
    right_line_pts=right_line_pts.astype(int)
...
def draw_lane_lines(original_image, warped_image, Minv, draw_info):
    ...
    pts=pts.astype(int)
    pts_mean=pts_mean.astype(int)
    cv2.fillPoly(color_warp, [pts], (0, 255, 0))
    cv2.fillPoly(color_warp, [pts_mean], (0, 255, 255))
